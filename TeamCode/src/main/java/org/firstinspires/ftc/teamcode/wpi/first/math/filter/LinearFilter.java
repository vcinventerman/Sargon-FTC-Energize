...
package org.firstinspires.ftc.teamcode.wpi.first.math.filter;

//import edu.wpi.first.math.MathSharedStore;
//import edu.wpi.first.math.MathUsageId;
import org.ejml.simple.SimpleBase;
import org.firstinspires.ftc.teamcode.wpi.first.util.CircularBuffer;
...
public class LinearFilter {
    ...
    public static LinearFilter finiteDifference(int derivative, int[] stencil, double period) {
        ...
        SimpleBase<SimpleMatrix> a = S.solve(d).divide(Math.pow(period, derivative));
